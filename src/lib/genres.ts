...
export const GENRE_CONFIG: Record<Genre, GenreConfig> = {
  musical: {
    ...
    companyTierLabels: ["소형 (신생·소규모)", "중형", "대형 (메이저)"],
  ...
  classical: {
    ...
    companyTierLabels: ["소형 (개인 기획·소규모)", "중형", "대형 (메이저)"],
  ...
  pop_concert: {
    ...
    companyTierLabels: ["소형 (인디·신인)", "중형", "대형 (메이저)"],
  ...
  play: {
    ...
    companyTierLabels: ["소형 (소극장·소규모)", "중형", "대형"],
  ...
  opera: {
    ...
    companyTierLabels: ["소형 (지역·소규모)", "중형", "대형"],
